...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand page-scroll" href="#page-top"><img src="../static/logotipo-trans.png" /></a>
    ...
    <header>
        <div class="container" id="page-top">
            <div class="intro-text">
                ...
                <div class="intro-heading">Divertite, explorá, disfrutá.</div>
                <a href="#servicios" class="page-scroll btn btn-xl">Conocé más sobre nosotros</a>
            </div>
        </div>
    </header>
            ...
            <div class="row text-center">
                <div class="col-md-4">
                   <a href="/Cliente/Catalogo.aspx">
                    ...
                    <a href="/Cliente/Catalogo.aspx" class="service-link"><h4 class="service-heading">E-Commerce</h4></a>
                ...
                <div class="col-md-4">
                    ...
                    <h4 class="service-heading">Red social</h4>
                    <p class="text-muted">Creá tu usuario y disfruta de interactuar con centenares de músicos dispuestos a compartir sus ideas.</p>
                    <p class="text-muted">Creá, descargá y compartí distorsiones con otros usuarios.</p>
                </div>
                <div class="col-md-4">
                    <span class="fa-stack fa-4x">
                        <i class="fa fa-circle fa-stack-2x text-primary"></i>
                    ...
                    <h4 class="service-heading">Ayuda en línea</h4>
    ...
    <section id="opinion">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading">Dejanos tu opinión</h2>
                    <h3 class="section-subheading text-muted">Completá la encuesta y ayudanos a mejorar nuestros productos y servicios</h3>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center" id="cabeceraContacto">
                    ...
                    <h3 class="section-subheading text-muted">Envianos tu mensaje indicando tu dirección de email y te contestaremos a la brevedad o si lo preferís, podés llamarnos al 0800-222-5154, de lunes a viernes de 9:00 a 18:00 horas.</h3>
