                ...
                if (result != null) {
                    ...
                    for (i = 0; i < result.length; i++) {
                        for (j = 0; j < result[i].preguntas.length; j++) {
                            ...
                            respuestas.className = 'row text-left encuesta  bg-warning';
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section id="contenedor">
        ...
        <div id="contenido" runat="server" class="row">
            <span id="spconfirmacion"> Su orden fue creada con el número de orden: ?.  Usted recibirá un email de confirmación de su compra dentro de las próximas 24 horas</span>
        </div>
        <hr />
