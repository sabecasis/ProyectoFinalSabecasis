<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/ConsumidorFinal.Master" CodeBehind="Catalogo.aspx.vb" Inherits="TFI.Catalogo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="content" class="container">
            ...
            <div class="col-md-9">
                ...
                <div class="row" id="contenido">
                      <div id="newsletter" class="row">
                        <asp:AdRotator ID="Add1" runat="server" />
                        </div>
                    <div class="col-md-9 ">
                        <div class="row thumbnail">
                            <div id="busqueda">
                                <span id="spprecio">Precio</span>
                                <select id="precio">
                                    <option value="2000">&lt; 2000</option>
                                    <option value="4000">&gt; 2000 &lt; 4000</option>
                                    <option value="4001">&gt; 4000</option>
                                </select>
                                <input type="checkbox" id="filtrodescuento" /><span id="spfiltrodescuento">Con descuento</span>
                                <input type="button" class="btn btn-success"  value="Buscar" id="buscarBtn" onclick="filtrar()" />
                                <input type="button" class="btn btn-info" value="Limpiar" id="limpiarBtn" onclick="limpiarFiltro()" />
                            </div>
                        </div>
                        <div class="row">
                            <div><input type="button" data-target="#comparar" data-toggle="modal" value="Comparar" id="compararproductos" name="compararproductos" disabled="disabled" onclick="comparar()"/></div>
                        </div>
                    </div>

                    <div class="col-sm-4 col-lg-4 col-md-4 pull-right">
                        <div class="thumbnail">
                            <h4><span id="spinformacion">Información</span></h4>
                            <p><span id="spcontenidoinformacion">Seleccione un producto, ingrese la cantidad y luego haga click en el botón de checkout para proceder con la compra.</span></p>
                        </div>
                        <input type="submit" class="btn btn-primary pull-right" id="checkout" name="checkout" onclick="setAccion(this.id)" value="Checkout"/>
                    </div>
     ...
     <section>
          <div id="comentarios" class="container collapse">
        ...
        <footer class="bg-success">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <p>Copyright &copy; Sabrina Abecasis 2015</p>
                </div>
                 <div class="col-md-4">
    ...
    <div id="detalleProducto" class="modal fade" role="dialog">
        <div id="detallesProd" class="modal-dialog modal-lg modal-content">
             <button type="button" class="btn btn-default btn-modal-close btn-circle pull-right" data-dismiss="modal"><i class="fa fa-times"></i></button>
              <div class="thumbnail">
                    <img  id="imagendescripcionprod" src="pepe.jpg" width="200" height="200" onerror="this.src='../static/product.jpg';"/>
                    <div class="caption-full">
                        <h4 id="hpreciodescripcion" class="pull-right">$24.99</h4>
                        <h4 id="hnombreproddescripcion">Product Name</h4>
                        <div id="divdescripcionprod" class="row text-center text-uppercase">
                        
                        </div>
                        <hr />
                        <div id="caracteristicas" class="row text-center">

                        </div>
                    </div>
                  
                    <div id="divdescuentos" class="row text-center">
...
Las violaciones de la seguridad del sistema o de la red pueden dar lugar a responsabilidad civil o penal. Doo-ba investigará sucesos que puedan implicar esas violaciones y puede involucrar a cooperar con las autoridades encargadas de hacer cumplir la ley para enjuiciar a los usuarios que participen en esas violaciones. Usted acepta no utilizar ningún dispositivo, software o rutina para interferir o intentar interferir con el buen funcionamiento de este Sitio o cualquier actividad que se lleve a cabo en este Sitio. Usted acepta, además, no utilizar ni intentar utilizar cualquier motor, software, herramienta, agente u otro dispositivo o mecanismo (incluyendo sin limitación los navegadores, arañas (spyders), robots y avatares) para navegar o buscar en este Sitio, que no sean los motores de búsqueda y agentes de búsqueda que Doo-ba hace disponibles en este Sitio y diferentes de los navegadores Web de terceros disponibles para el público en general (por ejemplo, Mozilla Firefox, Internet Explorer, Opera, Google Chrome, entre otros). El Usuario y/o el navegante ocasional del Sitio aceptan y reconocen expresamente que cualquier hecho, acto u omisión vinculadas con lo referido anteriormente y que tengan entidad para afectar la seguridad y/o el normal desarrollo del Sitio tienen entidad suficiente para causar a Doo-ba considerables daños y perjuicios incluyendo pero no limitándose a lucro cesante por caída y/o merma en las ventas, afectación de sus marcas, imagen comercial, pérdida de clientela, etc.
      ...
      <div id="comparar" class="modal fade" role="dialog">
        <div id="comparar2" class="modal-dialog modal-lg modal-content modal-dooba">
           <div class="container ">
          <div class="row">
              <button type="button" class="btn btn-default btn-modal-close btn-circle pull-left" data-dismiss="modal"><i class="fa fa-times"></i>X</button>
          </div>
            <div class="row">
                
             <div id="comparacion1" class="col-lg-4 con-borde">

            </div>
            <div id="comparacion2" class="col-lg-4 con-borde">
