...
Public Class ObtenerProximoIdHelper
    ...
    Public Function obtenerProximoIdDescuento() As Integer
        Return DescuentoDao.instancia().obtenerProximoId()
    End Function
    ...
    Public Function obtenerProximoIdNotaDeCredito() As Integer
        Try
            Dim dao As AbstractDao(Of NotaDeCredito) = NotaDeCreditoDao.instancia()
            Return dao.obtenerProximoId()
