...
Public Class GestorLogs
    ...
    Public Function obtenerBitacora(elemento As ElementoDeBitacora) As List(Of ElementoDeBitacora)
        Try
            ...
            criterio.fecha = elemento.fechaDesde
            criterio.usuario = elemento.usuario.nombre
            criterio.fechaHasta = elemento.fechaHasta
    ...
    Public Function obtenerLogErrores() As List(Of ErrorLog)
        Return ErrorLogDao.instancia().obtenerMuchos(Nothing)
    End Function
