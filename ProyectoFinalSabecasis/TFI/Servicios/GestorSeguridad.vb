...
Public Class GestorSeguridad
    ...
    Public Function buscarPermisosPorUrl(criterio As String) As List(Of Permiso)
        ...
        Try
            ...
            If Not usuario Is Nothing Then
                ...
                If Not oUsuario Is Nothing Then
                    If Criptografia.ObtenerInstancia().CompareHashMD5(password.Trim(), oUsuario.password) Then
                        ...
                        End If
                    Else
                        oUsuario.contadorMalaPassword += 1
                        If oUsuario.contadorMalaPassword > 3 Then
    ...
    Public Function cambiarPassword(usuario As String, password As String) As String
        Try
            Dim result As Boolean = UsuarioDao.instancia().modificarContrasenia(password.Trim(), usuario)
            If result Then
