    ...
    <section>
       ...
       <div class="col-md-6"> <span id="spnombre">Nombre: </span></div><div class="col-md-6"><input type="text" id="nombre" /></div>
        <div class="col-md-6"><span id="spapellido">Apellido: </span></div><div class="col-md-6"><input type="text" id="apellido" /></div>
         ...
         <div class="col-md-6"><span id="spnro">Nro.: </span></div><div class="col-md-6"><input type="text" id="nro" /></div>
         <div class="col-md-6"><span id="sppiso">Piso: </span></div><div class="col-md-6"><input type="text" id="piso" /></div>
         <div class="col-md-6"><span id="spdepto">Departamento: </span></div><div class="col-md-6"><input type="text" id="depto" /></div>
         <div class="col-md-6"><span id="sppais">Pais: </span></div><div class="col-md-6"><select id="pais" onchange="cargarProvincias(0);"></select></div>
         <div class="col-md-6"><span id="spprovincia">Provincia: </span></div><div class="col-md-6"><select id="provincia" onchange="cargarLocalidades(0);"></select></div>
         <div class="col-md-6"><span id="splocalidad">Localidad: </span></div><div class="col-md-6"><select id="localidad" ></select></div>
