...
Public Class EstadisticasDeFichas
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Not Me.IsPostBack Then
                preguntas = GestorUsuario.instancia().obtenerPreguntasDeEncuestaPorTipo(1, "", "")
    ...
    Protected Sub CMBPreguntas_SelectedIndexChanged(sender As Object, e As EventArgs)
        Try
            preguntas = GestorUsuario.instancia().obtenerPreguntasDeEncuestaPorTipo(1, fechaDesde.Value, fechaHasta.Value)
