...
Public Class DelegadoDocumentoDeIngresoDeStock
    Implements DelegadoDocumento

    Property ingreso As IngresoDeStock
    Public Sub New(oIngreso As IngresoDeStock)
        Me.ingreso = oIngreso
    End Sub
    ...
    Public Sub escribir(documento As iTextSharp.text.Document, escritor As iTextSharp.text.pdf.PdfWriter) Implements DelegadoDocumento.escribir
        ...
        headertable.AddCell("")
        Dim invoiceCell As PdfPCell = New PdfPCell(New Phrase("Comprobante de ingreso de mercadería en stock", titleFont))
        invoiceCell.HorizontalAlignment = 2
        invoiceCell.Border = Rectangle.NO_BORDER
        headertable.AddCell(invoiceCell)
        Dim noCell As PdfPCell = New PdfPCell(New Phrase("Número de ingreso :", bodyFont))
        noCell.HorizontalAlignment = 2
        noCell.Border = Rectangle.NO_BORDER
        headertable.AddCell(noCell)
        headertable.AddCell(New Phrase(Me.ingreso.nroIngreso.ToString(), bodyFont))
        ...
        Dim cell2 As PdfPCell = New PdfPCell(New Phrase("ARTÍCULO", boldTableFont))
        cell2.HorizontalAlignment = 1
        itemTable.AddCell(cell2)
        Dim cell3 As PdfPCell = New PdfPCell(New Phrase("CANTIDAD", boldTableFont))
        cell3.HorizontalAlignment = 1
        itemTable.AddCell(cell3)
        Dim cell4 As PdfPCell = New PdfPCell(New Phrase("NÚMERO PEDIDO", boldTableFont))
        ...
        Dim numberCell1 As PdfPCell = New PdfPCell(New Phrase(ingreso.producto.nroDeProducto, bodyFont))
        ...
        Dim numberCell2 As PdfPCell = New PdfPCell(New Phrase(ingreso.cantidad.ToString(), bodyFont))
        ...
        Dim numberCell3 As PdfPCell = New PdfPCell(New Phrase(ingreso.solicitud.nroPedido.ToString(), bodyFont))
